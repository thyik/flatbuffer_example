...
#ifndef FLATBUFFERS_GENERATED_MITULTMAP1_MITULTMAP1_H_
#define FLATBUFFERS_GENERATED_MITULTMAP1_MITULTMAP1_H_
...
inline flatbuffers::Offset<TblUnitInfo2> CreateTblUnitInfo2Direct(
    ...
    const stXY *outwaferCoor = 0) {
  return MitUltMap1::CreateTblUnitInfo2(
      _fbb,
      pocket,
      reel,
      bincode,
...
inline flatbuffers::Offset<TblLotInfo> CreateTblLotInfoDirect(
  ...
  return MitUltMap1::CreateTblLotInfo(
      _fbb,
...
inline flatbuffers::Offset<TblWaferInfo> CreateTblWaferInfoDirect(
    ...
    const stXY *maxRowCol = 0,
    const stfXY *dieGap = 0) {
  return MitUltMap1::CreateTblWaferInfo(
      _fbb,
      dieSize,
      notch,
...
struct UltRootBuilder {
  ...
  void add_type(MapType type) {
    fbb_.AddElement<int8_t>(UltRoot::VT_TYPE, static_cast<int8_t>(type), 1);
  }
  void add_lotInfo(flatbuffers::Offset<TblLotInfo> lotInfo) {
    fbb_.AddOffset(UltRoot::VT_LOTINFO, lotInfo);
  }
  void add_waferInfo(flatbuffers::Offset<TblWaferInfo> waferInfo) {
    fbb_.AddOffset(UltRoot::VT_WAFERINFO, waferInfo);
  }
...
inline flatbuffers::Offset<UltRoot> CreateUltRootDirect(
  ...
  return MitUltMap1::CreateUltRoot(
      _fbb,
      type,
      lotInfo,
      waferInfo,
...
inline const MitUltMap1::UltRoot *GetUltRoot(const void *buf) {
  return flatbuffers::GetRoot<MitUltMap1::UltRoot>(buf);
}

inline const MitUltMap1::UltRoot *GetSizePrefixedUltRoot(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<MitUltMap1::UltRoot>(buf);
}

inline bool VerifyUltRootBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<MitUltMap1::UltRoot>(nullptr);
}

inline bool VerifySizePrefixedUltRootBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<MitUltMap1::UltRoot>(nullptr);
}

inline void FinishUltRootBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<MitUltMap1::UltRoot> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_MITULTMAP1_MITULTMAP1_H_
